...
from .sample import *
from .paperToilet import paperToilet，Delete_Order，Update_Order，Query_Order
...
async def initapp(config):
    ...
    app.router.add_post("/Create_Order", Create_Order)
    app.router.add_post("/Delete_Order", Delete_Order)
    app.router.add_post("/Update_Order", Update_Order)
    app.router.add_post("/Query_Order", Query_Order)
